...
<form class="form" novalidate="novalidate" method="post"
      action="{{ \Illuminate\Support\Facades\URL::temporarySignedRoute('web.login.do', now()->addMinutes(15),['user' => $user->getKey()]) }}">
    @csrf
    ...
    <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
        <a href="{{ \Illuminate\Support\Facades\URL::temporarySignedRoute('web.login.recover', now()->addMinutes(15),['user' => $user->getKey()]) }}"
